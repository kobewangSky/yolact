...
coco2014_dataset = dataset_base.copy({
    ...
    'valid_info': './data/coco/evaluation/StoreEvaluation.json',
...
blackai_test_dataset = dataset_base.copy({
    'name': 'black_ai_store',

    'train_info': './data/evaluation/annotations/store_evaluation.json',
    'valid_info': './data/evaluation/annotations/store_evaluation.json',
